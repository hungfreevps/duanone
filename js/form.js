...
$('.login').submit(function(e) {
		...
		// var $sdt = document.getElementsById('sdt');
		...
		if($sdt == ""){
			createErrTult("Nhập lại số điện thoại", $sdt);
			error++;
		}
		...
		self.children().fadeOut(300,function(){ $(this).remove() })
		$('<p class="login__title">sign in <br></p><p class="success">You have successfully<br> signed in!</p>').appendTo(self)
		.hide().delay(300).fadeIn();
